...
/**
 * <p>DownloadRuntimeException indicates an error when updating the remote configuration./p>
 *
 * @author Oliver Dornauf
 * @since 1.0.0
 */

public class DownloadRuntimeException extends ContextedRuntimeException {
